			...
			<form action="php/login.php" method="post">
				<div>
					...
					<div class="checkbox" style="bold;">
						<span>
							<b>Do not have a myUMBC account?</b>
							<a class="checkbox" href="#myPopup1" id="register">Register as Guest</a>
						</span>
					</div>
				</div>
			</form>
		...
		<div class="is-hidden popup" id="myPopup1">
			<form action="php/register.php" method="post">
				<div>
					...
					<label class="" data-icon="u" for="fname" style="color:#FFC107;">Email:</label>
